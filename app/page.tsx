...
export default function Home() {
  ...
  return <main>
    <nav className="nav"><a href="#top" className="brand brand-logo" aria-label="Beaver Solutions home"><img className="brand-logo-image" src="/logo.jpg" alt="Beaver Solutions" /></a><div className="nav-links"><a href="#packages">Packages</a><a href="#process">How it works</a><a href="#faq">FAQ</a></div><a href="#contact" className="nav-cta">Let&apos;s talk <ArrowRight size={15}/></a><button className="menu" aria-label="Open menu"><Menu /></button></nav>
...
<section className="defense">
  ...
  <div>
    ...
    <footer><a className="brand brand-logo" href="#top" aria-label="Beaver Solutions home"><img className="brand-logo-image" src="/logo.jpg" alt="Beaver Solutions" /></a><p>Student Research & Software Development Support</p><span>© 2026 BeaverSolutions</span></footer>
  </main>;
}
